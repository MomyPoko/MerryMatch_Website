...
const Register: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col max-[1440px]:pt-[20px] min-[1919px]:pt-[75px]">
        ...
        <div className={`w-[1200px] flex flex-col items-center gap-[30px]`}>
          ...
          {currentStep === 1 && (
            <div className="w-full h-full flex flex-col gap-[16px]">
              ...
              <div className="pb-[17px] w-full grid grid-cols-2 gap-x-[40px] gap-y-[35px] max-[1440px]:gap-y-[20px]">
                <InputField
                  label="Name"
      ...
      {currentStep === 1 && (
        <div className="w-full h-[88px] px-[15%] border-[1px] align-bottom flex justify-between items-center">
      ...
      {currentStep === 2 && (
        <div className="w-full h-[88px] px-[200px] border-[1px] flex justify-between items-center">
          <span className="text-gray-800">
